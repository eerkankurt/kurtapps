...
const features = [
  {
    title: "Guided Dhikr",
    description: "Step-by-step guidance through traditional dhikr sequences with customisable counts and pacing.",
  },
  {
    title: "Daily Reminders",
    description: "Gentle, well-timed notifications that help you maintain a consistent spiritual practice.",
  },
  {
    title: "Progress Tracking",
    description: "Visualise your journey with beautiful charts showing streaks, counts, and monthly growth.",
  },
];
        ...
        <section className="pt-36 pb-20 px-6">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-white border border-black/[0.08] rounded-full px-4 py-1.5 mb-8 shadow-sm">
              ...
              <span className="text-xs text-[#888] tracking-wide font-medium">Spirituality</span>
            </div>
        ...
        <section className="px-6 pb-24">
          <div className="max-w-6xl mx-auto">
            <div
              ...
              style={{ height: 360, background: "linear-gradient(145deg, #faf5ff 0%, #ede9fe 55%, #ddd6fe 100%)" }}
            >
              <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse 60% 80% at 50% 50%, rgba(196,181,253,0.5), transparent)" }} />
              <div
                className="relative flex items-center justify-center"
                style={{ width: 120, height: 120, borderRadius: "26%", background: "linear-gradient(145deg, #6d28d9, #8b5cf6)", boxShadow: "0 24px 64px rgba(124,58,237,0.35)" }}
              >
        ...
        <section className="py-24 px-6 border-t border-[#f0eeea]">
          <div className="max-w-6xl mx-auto">
            <div className="mb-14">
              ...
              <h2 className="text-3xl md:text-4xl font-semibold text-[#111] tracking-tight">Designed for stillness.</h2>
            </div>
